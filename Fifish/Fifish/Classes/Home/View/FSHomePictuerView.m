...
-(void)setModel:(FSZuoPin *)model{
    _model = model;
    [self.imageView sd_setImageWithURL:[NSURL URLWithString:model.file_small] placeholderImage:[UIImage imageNamed:@"shuffling_default"] options:SDWebImageLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize) {
