...
- (void)setStaticTitleArr:(NSArray *)staticTitleArr {
    ...
    for (NSInteger j = 0; j < self.staticTitleArr.count; j++) {
        ...
        self.staticTitleLabel.font = [UIFont systemFontOfSize:13];
        ...
        // 设置高亮文字颜色
        _staticTitleLabel.highlightedTextColor = [UIColor colorWithHexString:@"#5aa6ff"];
    ...
    _indicatorView.backgroundColor = [UIColor colorWithHexString:@"#5aa6ff"];
...
- (void)setScrollTitleArr:(NSArray *)scrollTitleArr {
    ...
    for (NSUInteger i = 0; i < self.scrollTitleArr.count; i++) {
        ...
        // 设置高亮文字颜色
        _scrollTitleLabel.highlightedTextColor = [UIColor colorWithHexString:@"#BE8914"];
    ...
    // 添加指示器
    self.indicatorView = [[UIView alloc] init];
    _indicatorView.backgroundColor = [UIColor colorWithHexString:@"#BE8914"];
    _indicatorView.SG_height = indicatorHeight;
    _indicatorView.SG_y = self.frame.size.height - indicatorHeight;
    [self addSubview:_indicatorView];
