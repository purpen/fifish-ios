...
#import "FSLomofiFilter.h"

NSString *const kFSLomofiShaderString = SHADER_STRING
(
...
@implementation FSFilter6

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kFSLomofiShaderString]))
    {
        return nil;
    }
...
- (id)init
{
    ...
    FSFilter6 *filter = [[FSFilter6 alloc] init];
