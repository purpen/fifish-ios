...
#import "FSValenciaFilter.h"

NSString *const kFSValenciaShaderString = SHADER_STRING
(
...
@implementation FSFilter8

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kFSValenciaShaderString]))
    {
        return nil;
    }
...
@implementation FSValenciaFilter
...
- (id)init
{
    ...
    FSFilter8 *filter = [[FSFilter8 alloc] init];
