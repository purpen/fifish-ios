...
#import "FSSierraFilter.h"

NSString *const kFSSierraShaderString = SHADER_STRING
(
...
@implementation FSFilter11

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kFSSierraShaderString]))
    {
        return nil;
    }
...
- (id)init
{
    ...
    FSFilter11 *filter = [[FSFilter11 alloc] init];
