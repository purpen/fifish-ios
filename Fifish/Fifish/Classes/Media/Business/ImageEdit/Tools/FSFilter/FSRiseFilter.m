...
#import "FSRiseFilter.h"

NSString *const kFSRiseShaderString = SHADER_STRING
(
...
@implementation FSFilter4

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kFSRiseShaderString]))
    {
        return nil;
    }
...
- (id)init
{
    ...
    FSFilter4 *filter = [[FSFilter4 alloc] init];
