...
#import "FSAmaroFilter.h"

NSString *const kFSAmaroShaderString = SHADER_STRING
(
...
@implementation FSFilter3

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kFSAmaroShaderString]))
    {
        return nil;
    }
...
- (id)init
{
    ...
    FSFilter3 *filter = [[FSFilter3 alloc] init];
