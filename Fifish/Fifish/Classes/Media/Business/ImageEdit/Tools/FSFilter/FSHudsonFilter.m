...
#import "FSHudsonFilter.h"

NSString *const kFSHudsonShaderString = SHADER_STRING
(
...
@implementation FSFilter5

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kFSHudsonShaderString]))
    {
        return nil;
    }
...
- (id)init
{
    ...
    FSFilter5 *filter = [[FSFilter5 alloc] init];
