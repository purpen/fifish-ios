...
-(void)setModel2:(FSUserModel2 *)model2{
    _model2 = model2;
    [self.bg_imageView sd_setImageWithURL:nil placeholderImage:[UIImage imageNamed:model2.imageStr]];
...
-(void)setModel:(FSUserModel *)model{
    _model = model;
    [self.bg_imageView sd_setImageWithURL:nil placeholderImage:[UIImage imageNamed:@"me_bg_large1"]];
